package com.yinglan.scg.adapter.mine.personaldata.search;
 ...
 *  服务地区分类---GridView
 */
public class ServiceAreaGridViewAdapter extends BGAAdapterViewAdapter<DataBean> {

    public ServiceAreaGridViewAdapter(Context context) {
