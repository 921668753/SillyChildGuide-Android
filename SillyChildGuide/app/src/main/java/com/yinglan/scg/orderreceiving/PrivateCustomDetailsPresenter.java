...
public class PrivateCustomDetailsPresenter implements PrivateCustomDetailsContract.Presenter {

    private PrivateCustomDetailsContract.View mView;

    public PrivateCustomDetailsPresenter(PrivateCustomDetailsContract.View view) {
        mView = view;
