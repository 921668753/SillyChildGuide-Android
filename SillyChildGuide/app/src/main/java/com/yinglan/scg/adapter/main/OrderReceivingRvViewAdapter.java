 ...
 * 接单列表适配器
 */
public class OrderReceivingRvViewAdapter extends BGARecyclerViewAdapter<OrderBean.DataBean.ResultBean> {

    public OrderReceivingRvViewAdapter(RecyclerView recyclerView) {
        super(recyclerView);
    }
...
//    }
    ...
    @Override
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, OrderBean.DataBean.ResultBean model) {
