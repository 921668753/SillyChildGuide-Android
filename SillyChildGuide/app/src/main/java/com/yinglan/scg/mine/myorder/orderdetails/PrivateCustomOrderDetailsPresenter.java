 ...
 */
public class PrivateCustomOrderDetailsPresenter implements PrivateCustomOrderDetailsContract.Presenter {

    private PrivateCustomOrderDetailsContract.View mView;

    public PrivateCustomOrderDetailsPresenter(PrivateCustomOrderDetailsContract.View view) {
        mView = view;
